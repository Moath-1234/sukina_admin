...
import { CButton, CCard, CCardBody, CCardHeader, CCollapse, CDropdown, CDropdownItem, CDropdownMenu, CDropdownToggle, CForm, CImg, CInput, CNavbar, CNavbarBrand, CNavbarNav, CNavbarText, CNavLink, CToggler } from '@coreui/react';
            ...
            <CCard>
                ...
                <CCardBody>
                    <CNavbar color="faded" light>
                        <CNavbarBrand>
                            <CImg src="https://placekitten.com/g/30/30" className="d-inline-block align-top" alt="" />
                            CoreUI React
                        </CNavbarBrand>
                    </CNavbar>
                </CCardBody>
