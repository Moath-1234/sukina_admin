              ...
              <CRow>
                <CCol xs="12">
                  <CFormGroup>
                    ...
                    <CInput id="name" placeholder="Enter your name" value={formData.name} onChange={async (text)=>{ await setFormData({...formData,name:text.target.value}); console.log(formData) }} required />
                  </CFormGroup>
                </CCol>
              </CRow>
              <CRow>
                <CCol xs="12">
                  <CFormGroup>
                    ...
                    <CInput id="ccnumber" placeholder="Enter your ccnumber" value={formData.email} onChange={async (text)=>{ await setFormData({...formData,email:text.target.value}); console.log(formData) }} required />
