...
import { CBadge, CButton, CButtonGroup, CCallout, CCard, CCardBody, CCardFooter, CCardHeader, CCol, CProgress, CRow } from '@coreui/react';
import CIcon from '@coreui/icons-react';

import MainChartExample from '../charts/MainChartExample.js';

export class Dashboard extends Component {
    state = { Orders: 0, products: 0, stores: 0, users: 0, Loader: true };
                    ...
                    <CCardBody>
                        <CRow>
                            ...
                            <CCol sm="7" className="d-none d-md-block">
                                <CButton color="primary" className="float-right"><CIcon name="cil-cloud-download" /></CButton>

                                <CButtonGroup className="float-right mr-3">
                                    { ['Day', 'Month', 'Year'].map((value) => <CButton color="outline-secondary" key={ value } className="mx-0" active={ value === 'Month' }>{ value }</CButton>) }
                                </CButtonGroup>
                            </CCol>
                        </CRow>
                                ...
                                <CRow>
                                    ...
                                    <CCol xs="12" md="6" xl="6">
                                        ...
                                        <div className="progress-group">
                                            ...
                                            <div className="progress-group-bars"><CProgress className="progress-xs" color="success" value="56" /></div>
                                        </div>
